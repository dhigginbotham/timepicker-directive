  ...
  app.directive('timepicker', [
      function() {
        ...
        function link(scope, el, attrs) {
          ...
          function updateDateAttr(el, date, time) {
            if (typeof date != 'undefined' && typeof time != 'undefined') {
              el.setAttribute('data-dateobj', new Date(date + ' ' + time));
            } else {
              el.setAttribute('data-dateobj', false);
            }
          }
          ...
          function handleDateChange(dirty, clean) {
            if (dirty) {
              ...
              updateDateAttr(el[0], dirty, scope.currentTime);
            }
          }
  
          function handleTimeChange(dirty, clean) {
            if (dirty) updateDateAttr(el[0], scope.currentDate, dirty);
          }
          ...
          jQuery(document).bind('cbox_load', function(){
            ...
            scope.currentTime = scope.defaultTime || scope.times[0];
          });
